...
| 2 | **Pets não convencionais 24h.** Conflito declarado: o FAQ do site atual diz "foco principal em cães e gatos"; o post de `/assets` anuncia atendimento 24h para não convencionais. A copy foi escrita a favor do post, defensivamente ("confirme a espécie antes de sair de casa"). Se estiver errado, saem a faixa da seção 07 e a pergunta 7 do FAQ. | Alto — diferencial forte se confirmado, promessa falsa se não | **SIM** |
